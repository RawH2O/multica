...
type Daemon struct {
	...
	// runUpdateFn executes the configured GitHub Release download upgrade. Set to d.runUpdate by
...
// runUpdate executes the configured GitHub Release download against
